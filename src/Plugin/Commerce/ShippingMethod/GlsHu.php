...
namespace Drupal\commerce_gls_hu\Plugin\Commerce\ShippingMethod;
 ...
 *   id = "gls_hu",
 *   label = @Translation("GLS HU"),
 * )
 */
class GlsHu extends ShippingMethodBase {

  /**
   * Constructs a new GLS HU object.
   *
